...
class Surgeon:
    ...
    def add_job(self, job, layer, *,
        ...
        if job == 'delete_channels':
            # If not all _inbound_nodes are selected, the new layer is renamed
    ...
    def operate(self):
        ...
        for node in sorted_nodes:
            ...
            sub_output_nodes = utils.get__inbound_nodes(node)
